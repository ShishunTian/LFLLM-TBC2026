...
class REFER:
    def __init__(self, data_root, dataset="refcoco", splitBy="unc"):
        ...
        elif dataset == "ref-urbanlf-syn":
            self.IMAGE_DIR = osp.join(data_root, "images/urbanlf/syn/val/new")
        elif dataset == "ref-urbanlf-real":
            self.IMAGE_DIR = "/mnt/mdisk/xxx/LFLLM/dataset/rlfos/Real-val/new"
        else:
        ...
        if dataset == 'ref-urbanlf-syn':
            ref_file = osp.join(self.DATA_DIR, "ref-urbanlf-syn.json")
            self.data = {}
            self.data["dataset"] = dataset
            self.data['refs'] = json.load(open(ref_file, 'r'))
        elif dataset == 'ref-urbanlf-real':
            ref_file = osp.join(self.DATA_DIR, "ref-urbanlf-real.json")
            self.data = {}
            self.data["dataset"] = dataset
            self.data['refs'] = json.load(open(ref_file, 'r'))
        else:
    ...
    def getRefIds(self, image_ids=[], cat_ids=[], ref_ids=[], split=""):
        ...
        if len(image_ids) == len(cat_ids) == len(ref_ids) == len(split) == 0:
            ...
            if not len(split) == 0:
                ...
                elif split == "train" or split == "val" or split == "no-o" or split == "o-1" or split == "o-2" or split == "o-3" or split == "distance" or split == "closest" or split == "behind" or split == "front" or split == "near":
